...
import com.example.xyz.bayrakquizuygulamasi.databinding.ActivityQuizBinding
...
class QuizActivity : AppCompatActivity() {
    ...
    fun soruYukle(){
        ...
        tasarim.imageViewBayrak.setImageResource(resources.getIdentifier(dogruSoru.bayrak_rasim,"drawable",packageName))
    ...
    fun dogruKontrol(button: Button){
        ...
        tasarim.textViewYanlS.text = "Yanlış : $yanlisSayac"
